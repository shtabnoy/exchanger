...
var exchangeSuccess = exports.exchangeSuccess = function exchangeSuccess(rates) {
    return {
...
var getExchangeRates = exports.getExchangeRates = function getExchangeRates(base) {
    return function (dispatch) {
        ...
        fetch(BASE_URL + '/latest?base=' + base).then(function (response) {
            ...
            return dispatch(exchangeSuccess(response.rates));
        }).catch(function () {
...
var ExchangerWidget = function (_Component) {
    _inherits(ExchangerWidget, _Component);

    function ExchangerWidget() {
        _classCallCheck(this, ExchangerWidget);

        return _possibleConstructorReturn(this, (ExchangerWidget.__proto__ || Object.getPrototypeOf(ExchangerWidget)).apply(this, arguments));
    }

    _createClass(ExchangerWidget, [{
        key: 'render',
    ...
    return ExchangerWidget;
}(_react.Component);

exports.default = ExchangerWidget;
...
/*
 ...
 LICENSE file in the root directory of this source tree.
*/
var f=__webpack_require__(4),p=__webpack_require__(11);__webpack_require__(1);var r=__webpack_require__(2);
...
var App = function (_Component) {
    ...
    function App() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = App.__proto__ || Object.getPrototypeOf(App)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
            ...
            currencyTo: 'GBP',
            amountTo: 0
        }, _this.getCurrentRate = function () {
            var rates = _this.props.rates;
            var currencyTo = _this.state.currencyTo;

            return rates ? rates[currencyTo] : 0;
        }, _this.currentRateSection = function () {
            var _this$state = _this.state,
                currencyTo = _this$state.currencyTo,
                currencyFrom = _this$state.currencyFrom;

            var currentRate = _this.getCurrentRate();
            return _react2.default.createElement(
                'div',
                { id: 'rate' },
                '1 ',
            ...
            _this.setState({
                amountFrom: value,
                amountTo: (_this.getCurrentRate() * value).toFixed(2)
            });
    ...
    _createClass(App, [{
        ...
        value: function render() {
            var _state = this.state,
                currencyFrom = _state.currencyFrom,
                currencyTo = _state.currencyTo,
                amountFrom = _state.amountFrom,
                amountTo = _state.amountTo;
...
App.propTypes = {
    ...
    rates: _propTypes2.default.shape().isRequired,
