...
var SET_TARGET_CURRENCY = exports.SET_TARGET_CURRENCY = 'SET_TARGET_CURRENCY';
var RESET_TARGET_CURRENCY = exports.RESET_TARGET_CURRENCY = 'RESET_TARGET_CURRENCY';
var SET_TARGET_AMOUNT = exports.SET_TARGET_AMOUNT = 'SET_TARGET_AMOUNT';
...
var exchangeSuccess = exports.exchangeSuccess = function exchangeSuccess(info) {
    return {
...
var setTargetCurrency = exports.setTargetCurrency = function setTargetCurrency(currency) {
    return {
...
var setTargetAmount = exports.setTargetAmount = function setTargetAmount(amount) {
    return {
...
var updateTarget = exports.updateTarget = function updateTarget(targetCurrency, amountFrom, rate) {
...
var resetTargetCurrency = exports.resetTargetCurrency = function resetTargetCurrency(currency) {
    return {
...
var getExchangeRates = exports.getExchangeRates = function getExchangeRates(base) {
    return function (dispatch) {
        ...
        fetch(BASE_URL + '/latest?base=' + base).then(function (response) {
            ...
            return dispatch(resetTargetCurrency());
        }).catch(function () {
...
var m=__webpack_require__(5),n=__webpack_require__(11),p=__webpack_require__(2),q="function"===typeof Symbol&&Symbol["for"],r=q?Symbol["for"]("react.element"):60103,t=q?Symbol["for"]("react.call"):60104,u=q?Symbol["for"]("react.return"):60105,v=q?Symbol["for"]("react.portal"):60106,w=q?Symbol["for"]("react.fragment"):60107,x="function"===typeof Symbol&&Symbol.iterator;
...
exports.default = function () {
    ...
    switch (action.type) {
        ...
        case _actions.SET_TARGET_CURRENCY:
            return _extends({}, state, {
                targetCurrency: action.currency
            });
        case _actions.RESET_TARGET_CURRENCY:
            return _extends({}, state, {
                targetCurrency: state.info.base === state.targetCurrency ? state.currencies.filter(function (currency) {
                    return currency !== state.info.base;
                })[0] : state.targetCurrency
            });
        case _actions.SET_TARGET_AMOUNT:
            return _extends({}, state, {
...
var _FontTriangle = __webpack_require__(59);

var _FontTriangle2 = _interopRequireDefault(_FontTriangle);
...
var App = function (_Component) {
    ...
    function App() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = App.__proto__ || Object.getPrototypeOf(App)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
            amountFrom: 0
            // amountTo: 0
        }, _this.getBase = function () {
            return _this.props.info.base;
        }, _this.getNextBase = function () {
            var currencies = _this.props.currencies;

            var len = currencies.length;
            var nextCurrencyIndex = currencies.indexOf(_this.getBase()) + 1;
            _this.props.getExchangeRates(currencies[(nextCurrencyIndex % len + len) % len]);
        }, _this.getPreviousBase = function () {
            var currencies = _this.props.currencies;

            var len = currencies.length;
            var previousCurrencyIndex = currencies.indexOf(_this.getBase()) - 1;
            _this.props.getExchangeRates(currencies[(previousCurrencyIndex % len + len) % len]);
        }, _this.getTargetCurrency = function () {
            return _this.props.targetCurrency;
        }, _this.getNextTarget = function () {
            var filteredCurrencies = _this.props.currencies.filter(function (currency) {
                return currency !== _this.getBase();
            });
            var len = filteredCurrencies.length;
            var index = filteredCurrencies.indexOf(_this.getTargetCurrency()) + 1;
            var targetCurrency = filteredCurrencies[(index % len + len) % len];
            _this.props.updateTarget(targetCurrency, _this.state.amountFrom, _this.getRate(targetCurrency));
            ...
            var targetCurrency = filteredCurrencies[(index % len + len) % len];
            _this.props.updateTarget(targetCurrency, _this.state.amountFrom, _this.getRate(targetCurrency));
        }, _this.getRate = function (currency) {
            var rates = _this.props.info.rates;

            return rates ? rates[currency] : 0;
        }, _this.currentRateSection = function () {
            var targetCurrency = _this.getTargetCurrency();
            return _react2.default.createElement(
                'div',
            ...
            _this.props.setTargetAmount((_this.getRate(_this.getTargetCurrency()) * value).toFixed(2));
    ...
    _createClass(App, [{
        ...
        value: function render() {
            var amountFrom = this.state.amountFrom;
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'button',
                        { className: 'btn', onClick: this.getPreviousBase },
                        _react2.default.createElement(_FontTriangle2.default, { direction: 'left' })
                    ),
                    this.getBase(),
                    ' ',
                    ...
                    _react2.default.createElement(
                        'button',
                        { className: 'btn', onClick: this.getNextBase },
                        _react2.default.createElement(_FontTriangle2.default, { direction: 'right' })
                    )
                ),
                _react2.default.createElement(
                    'div',
                    ...
                    _react2.default.createElement(
                        'button',
                        { className: 'btn', onClick: this.getPreviousTarget },
                        _react2.default.createElement(_FontTriangle2.default, { direction: 'left' })
                    ),
                    ...
                    _react2.default.createElement(
                        'button',
                        { className: 'btn', onClick: this.getNextTarget },
                        _react2.default.createElement(_FontTriangle2.default, { direction: 'right' })
                    )
                )
            );
...
App.propTypes = {
    ...
    setTargetCurrency: _propTypes2.default.func.isRequired,
    setTargetAmount: _propTypes2.default.func.isRequired,
    updateTarget: _propTypes2.default.func.isRequired,
    // isLoading: PropTypes.bool.isRequired,
    // isError: PropTypes.bool.isRequired,
    info: _propTypes2.default.shape().isRequired,
    ...
    targetAmount: _propTypes2.default.string.isRequired
};
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    return {
        ...
        setTargetCurrency: function setTargetCurrency(currency) {
            return dispatch((0, _actions.setTargetCurrency)(currency));
        },
        setTargetAmount: function setTargetAmount(amount) {
            return dispatch((0, _actions.setTargetAmount)(amount));
        },
        updateTarget: function updateTarget(targetCurrency, amountFrom, rate) {
            return dispatch((0, _actions.updateTarget)(targetCurrency, amountFrom, rate));
        }
    };
};
...
var FontTriangle = function FontTriangle(_ref) {
