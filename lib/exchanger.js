...
exports.getExchangeRates = exports.stopPolling = exports.updateBaseValue = exports.updateTargetCurrency = exports.exchangeError = exports.exchangeSuccess = exports.exchangeIsLoading = exports.UPDATE_BASE_VALUE = exports.UPDATE_TARGET_CURRENCY = exports.EXCHANGE_ERROR = exports.EXCHANGE_SUCCESS = exports.EXCHANGE_LOADING = exports.BASE_URL = undefined;

__webpack_require__(58);

var BASE_URL = exports.BASE_URL = 'https://api.fixer.io'; /* global fetch */
...
var exchangeError = exports.exchangeError = function exchangeError(error) {
    return {
        type: 'EXCHANGE_ERROR',
        error: error
    };
...
var getExchangeRates = exports.getExchangeRates = function getExchangeRates(base) {
    return function (dispatch) {
        ...
        return fetch(BASE_URL + '/latest?base=' + base).then(function (response) {
            ...
            return dispatch(exchangeError('Error: ' + err.message));
        });
    };
};
...
exports.getDefaultState = undefined;

var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };

var _actions = __webpack_require__(23);

var getDefaultState = exports.getDefaultState = function getDefaultState() {
    return {
...
var _ErrorBlock = __webpack_require__(63);

var _ErrorBlock2 = _interopRequireDefault(_ErrorBlock);

var _InfoBlock = __webpack_require__(64);
...
var App = function (_Component) {
    ...
    function App() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = App.__proto__ || Object.getPrototypeOf(App)).call.apply(_ref, [this].concat(args))), _this), _this.getBase = function (direction) {
            var _this$props = _this.props,
                currencies = _this$props.currencies,
                baseCurrency = _this$props.baseCurrency,
                getExchangeRates = _this$props.getExchangeRates;

            var len = currencies.length;
            var index = currencies.indexOf(baseCurrency);
            if (direction === 'next') index++;
            if (direction === 'previous') index--;
            getExchangeRates(currencies[(index % len + len) % len]);
        }, _this.getTarget = function (direction) {
            var _this$props2 = _this.props,
                currencies = _this$props2.currencies,
                targetCurrency = _this$props2.targetCurrency,
                baseCurrency = _this$props2.baseCurrency,
                updateTargetCurrency = _this$props2.updateTargetCurrency;

            var filteredCurrencies = currencies.filter(function (currency) {
                return currency !== baseCurrency;
            });
            var len = filteredCurrencies.length;
            var index = filteredCurrencies.indexOf(targetCurrency);
            if (direction === 'next') index++;
            if (direction === 'previous') index--;
            updateTargetCurrency(filteredCurrencies[(index % len + len) % len]);
        }, _this.startPolling = function () {
            return _this.props.getExchangeRates(_this.props.baseCurrency);
    ...
    _createClass(App, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement(_ErrorBlock2.default, {
                    className: 'block error-block',
                    error: error
                }),
                _react2.default.createElement(_InfoBlock2.default, {
                    className: 'block',
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    return {
        getExchangeRates: function getExchangeRates(base) {
            return dispatch((0, _actions.getExchangeRates)(base));
        },
        updateTargetCurrency: function updateTargetCurrency(currency) {
            return dispatch((0, _actions.updateTargetCurrency)(currency));
        },
        updateBaseValue: function updateBaseValue(value) {
            return dispatch((0, _actions.updateBaseValue)(value));
        },
        stopPolling: function stopPolling() {
            return dispatch(_actions.stopPolling);
        }
    };
};
...
var BaseBlock = function BaseBlock(_ref) {
    var baseCurrency = _ref.baseCurrency,
        ...
        getBase = _ref.getBase,
        updateBaseValue = _ref.updateBaseValue,
        disabled = _ref.disabled,
        className = _ref.className;
    return _react2.default.createElement(
        'div',
        { id: 'from', className: className },
...
BaseBlock.propTypes = {
    baseCurrency: _propTypes2.default.string.isRequired,
    baseValue: _propTypes2.default.number.isRequired,
    getBase: _propTypes2.default.func.isRequired,
    updateBaseValue: _propTypes2.default.func.isRequired,
...
var TargetBlock = function TargetBlock(_ref) {
    ...
    return _react2.default.createElement(
        'div',
        { id: 'to', className: className },
        _react2.default.createElement(
            'button',
            {
                className: 'btn',
                onClick: function onClick() {
                    return getTarget('previous');
                },
                disabled: disabled
            },
            '\u25C0'
...
InfoBlock.propTypes = {
    startPolling: _propTypes2.default.func.isRequired,
    stopPolling: _propTypes2.default.func.isRequired,
    className: _propTypes2.default.string
};
