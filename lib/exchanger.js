...
exports.getExchangeRates = exports.resetTargetCurrency = exports.setTargetCurrency = exports.exchangeError = exports.exchangeSuccess = exports.exchangeIsLoading = exports.RESET_TARGET_CURRENCY = exports.SET_TARGET_CURRENCY = exports.EXCHANGE_ERROR = exports.EXCHANGE_SUCCESS = exports.EXCHANGE_LOADING = undefined;
...
exports.default = function () {
    ...
    switch (action.type) {
        ...
        case _actions.RESET_TARGET_CURRENCY:
            return _extends({}, state, {
                targetCurrency: state.exchangeData.base === state.targetCurrency ? state.currencies.filter(function (currency) {
                    return currency !== state.exchangeData.base;
...
var _FontTriangle = __webpack_require__(60);
...
var App = function (_Component) {
    ...
    function App() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = App.__proto__ || Object.getPrototypeOf(App)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
            baseValue: 0
        }, _this.getBaseCurrency = function () {
            return _this.props.baseCurrency;
        }, _this.getNextBase = function () {
            var currencies = _this.props.currencies;

            var len = currencies.length;
            var nextCurrencyIndex = currencies.indexOf(_this.getBaseCurrency()) + 1;
            _this.props.getExchangeRates(currencies[(nextCurrencyIndex % len + len) % len]);
        }, _this.getPreviousBase = function () {
            var currencies = _this.props.currencies;

            var len = currencies.length;
            var previousCurrencyIndex = currencies.indexOf(_this.getBaseCurrency()) - 1;
            ...
            var filteredCurrencies = _this.props.currencies.filter(function (currency) {
                return currency !== _this.getBaseCurrency();
            });
            ...
            _this.props.setTargetCurrency(targetCurrency);
        ...
        }, _this.renderBaseBlock = function () {
            var baseValue = _this.state.baseValue;
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'button',
                    { className: 'btn', onClick: _this.getPreviousBase },
                ...
                _react2.default.createElement(
                    'button',
                    { className: 'btn', onClick: _this.getNextBase },
                    _react2.default.createElement(_FontTriangle2.default, { direction: 'right' })
                )
            );
        }, _this.renderTargetBlock = function () {
            var targetCurrency = _this.getTargetCurrency();
            var baseValue = _this.state.baseValue;
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'button',
                    { className: 'btn', onClick: _this.getPreviousTarget },
                    _react2.default.createElement(_FontTriangle2.default, { direction: 'left' })
                ),
                targetCurrency,
                ' ',
                (_this.getRate(targetCurrency) * baseValue).toFixed(2),
                _react2.default.createElement(
                    'button',
                    { className: 'btn', onClick: _this.getNextTarget },
                    _react2.default.createElement(_FontTriangle2.default, { direction: 'right' })
                )
            );
