(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("exchanger", [], factory);
	else if(typeof exports === 'object')
		exports["exchanger"] = factory();
	else
		root["exchanger"] = factory();
})(this, function() {
...
exports.getExchangeRates = exports.stopPolling = exports.updateBaseValue = exports.updateTargetCurrency = exports.exchangeError = exports.exchangeSuccess = exports.exchangeIsLoading = exports.UPDATE_BASE_VALUE = exports.UPDATE_TARGET_CURRENCY = exports.EXCHANGE_ERROR = exports.EXCHANGE_SUCCESS = exports.EXCHANGE_LOADING = undefined;

__webpack_require__(58);

var BASE_URL = 'https://api.fixer.io'; /* global fetch */
var EXCHANGE_LOADING = exports.EXCHANGE_LOADING = 'EXCHANGE_LOADING';
var EXCHANGE_SUCCESS = exports.EXCHANGE_SUCCESS = 'EXCHANGE_SUCCESS';
var EXCHANGE_ERROR = exports.EXCHANGE_ERROR = 'EXCHANGE_ERROR';
var UPDATE_TARGET_CURRENCY = exports.UPDATE_TARGET_CURRENCY = 'UPDATE_TARGET_CURRENCY';
var UPDATE_BASE_VALUE = exports.UPDATE_BASE_VALUE = 'UPDATE_BASE_VALUE';

var TIMEOUT = 10000;
var timer = void 0;

var exchangeIsLoading = exports.exchangeIsLoading = function exchangeIsLoading(bool) {
    return {
...
var exchangeSuccess = exports.exchangeSuccess = function exchangeSuccess(exchangeData) {
    return {
...
var exchangeError = exports.exchangeError = function exchangeError(bool) {
    return {
        type: 'EXCHANGE_ERROR',
        isError: bool
    };
...
var updateTargetCurrency = exports.updateTargetCurrency = function updateTargetCurrency(currency) {
    return {
...
var updateBaseValue = exports.updateBaseValue = function updateBaseValue(value) {
    return {
...
var stopPolling = exports.stopPolling = function stopPolling() {
    clearTimeout(timer);
};

var getExchangeRates = exports.getExchangeRates = function getExchangeRates(base) {
    return function (dispatch) {
        dispatch(exchangeIsLoading(true));
        fetch(BASE_URL + '/latest?base=' + base).then(function (response) {
            if (!response.ok) {
            ...
            return dispatch(exchangeSuccess(response));
        }).then(function () {
            clearTimeout(timer);
            timer = setTimeout(function () {
                return dispatch(getExchangeRates(base));
            }, TIMEOUT);
        }).catch(function () {
            return dispatch(exchangeError(true));
        });
    };
};
...
var ExchangeWidget = function (_Component) {
    _inherits(ExchangeWidget, _Component);

    function ExchangeWidget() {
        _classCallCheck(this, ExchangeWidget);

        return _possibleConstructorReturn(this, (ExchangeWidget.__proto__ || Object.getPrototypeOf(ExchangeWidget)).apply(this, arguments));
    }

    _createClass(ExchangeWidget, [{
        key: 'render',
...
exports.default = ExchangeWidget;
...
var m=__webpack_require__(5),n=__webpack_require__(11),p=__webpack_require__(3),q="function"===typeof Symbol&&Symbol["for"],r=q?Symbol["for"]("react.element"):60103,t=q?Symbol["for"]("react.call"):60104,u=q?Symbol["for"]("react.return"):60105,v=q?Symbol["for"]("react.portal"):60106,w=q?Symbol["for"]("react.fragment"):60107,x="function"===typeof Symbol&&Symbol.iterator;
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(18), __webpack_require__(46)(module)))
...
var _exchange = __webpack_require__(57);
...
exports.default = function () {
    ...
    switch (action.type) {
        case _actions.EXCHANGE_LOADING:
            return _extends({}, state, {
                isLoading: action.isLoading
            });
        case _actions.EXCHANGE_SUCCESS:
            return _extends({}, state, {
                exchangeData: action.exchangeData,
                targetCurrency: action.exchangeData.base === state.targetCurrency ? state.currencies.filter(function (currency) {
                    return currency !== action.exchangeData.base;
                })[0] : state.targetCurrency
            });
        case _actions.EXCHANGE_ERROR:
            return _extends({}, state, {
                isError: action.isError
            });
        case _actions.UPDATE_TARGET_CURRENCY:
            return _extends({}, state, {
                targetCurrency: action.currency
            });
        case _actions.UPDATE_BASE_VALUE:
            return _extends({}, state, {
...
var _RateBlock = __webpack_require__(60);

var _RateBlock2 = _interopRequireDefault(_RateBlock);

var _BaseBlock = __webpack_require__(61);

var _BaseBlock2 = _interopRequireDefault(_BaseBlock);

var _TargetBlock = __webpack_require__(62);

var _TargetBlock2 = _interopRequireDefault(_TargetBlock);
...
var App = function (_Component) {
    ...
    function App() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = App.__proto__ || Object.getPrototypeOf(App)).call.apply(_ref, [this].concat(args))), _this), _this.getNextBase = function () {
            var _this$props = _this.props,
                currencies = _this$props.currencies,
                baseCurrency = _this$props.baseCurrency;

            var len = currencies.length;
            var nextCurrencyIndex = currencies.indexOf(baseCurrency) + 1;
            _this.props.getExchangeRates(currencies[(nextCurrencyIndex % len + len) % len]);
        }, _this.getPreviousBase = function () {
            var _this$props2 = _this.props,
                currencies = _this$props2.currencies,
                baseCurrency = _this$props2.baseCurrency;

            var len = currencies.length;
            var previousCurrencyIndex = currencies.indexOf(baseCurrency) - 1;
            _this.props.getExchangeRates(currencies[(previousCurrencyIndex % len + len) % len]);
        }, _this.getNextTarget = function () {
            var filteredCurrencies = _this.props.currencies.filter(function (currency) {
                return currency !== _this.props.baseCurrency;
            });
            var len = filteredCurrencies.length;
            var index = filteredCurrencies.indexOf(_this.props.targetCurrency) + 1;
            var targetCurrency = filteredCurrencies[(index % len + len) % len];
            _this.props.updateTargetCurrency(targetCurrency);
        }, _this.getPreviousTarget = function () {
            var filteredCurrencies = _this.props.currencies.filter(function (currency) {
                return currency !== _this.props.baseCurrency;
            });
            var len = filteredCurrencies.length;
    ...
    _createClass(App, [{
        ...
        value: function render() {
            var _props = this.props,
                baseCurrency = _props.baseCurrency,
                baseValue = _props.baseValue,
                targetCurrency = _props.targetCurrency,
                rates = _props.rates;
            ...
            return _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement(_RateBlock2.default, {
                    baseCurrency: baseCurrency,
                    targetCurrency: targetCurrency,
                    rate: rates[targetCurrency]
                }),
                _react2.default.createElement(_BaseBlock2.default, {
                    baseCurrency: baseCurrency,
                    baseValue: baseValue,
                ...
                _react2.default.createElement(_TargetBlock2.default, {
                    baseValue: baseValue,
                    targetCurrency: targetCurrency,
                    rate: rates[targetCurrency],
                ...
                _react2.default.createElement(
                    'button',
                    { onClick: this.props.stopPolling },
                    'Stop polling'
                )
            );
        }
...
App.propTypes = {
    getExchangeRates: _propTypes2.default.func.isRequired,
    updateTargetCurrency: _propTypes2.default.func.isRequired,
    updateBaseValue: _propTypes2.default.func.isRequired,
    stopPolling: _propTypes2.default.func.isRequired,
    // isLoading: PropTypes.bool.isRequired,
    // isError: PropTypes.bool.isRequired,
    baseCurrency: _propTypes2.default.string.isRequired,
    baseValue: _propTypes2.default.number.isRequired,
    rates: _propTypes2.default.shape(_defineProperty({}, _propTypes2.default.string, _propTypes2.default.number)).isRequired,
    currencies: _propTypes2.default.arrayOf(_propTypes2.default.string).isRequired,
    targetCurrency: _propTypes2.default.string.isRequired
};
...
var mapDispatchToProps = {
    getExchangeRates: _actions.getExchangeRates,
    updateTargetCurrency: _actions.updateTargetCurrency,
    updateBaseValue: _actions.updateBaseValue,
    stopPolling: _actions.stopPolling
};
...
var RateBlock = function RateBlock(_ref) {
    var baseCurrency = _ref.baseCurrency,
        targetCurrency = _ref.targetCurrency,
        rate = _ref.rate;
    return _react2.default.createElement(
        'div',
        { id: 'rate', className: 'currency-block' },
...
var BaseBlock = function BaseBlock(_ref) {
    var baseCurrency = _ref.baseCurrency,
        baseValue = _ref.baseValue,
        getPreviousBase = _ref.getPreviousBase,
        getNextBase = _ref.getNextBase,
        updateBaseValue = _ref.updateBaseValue;
    return _react2.default.createElement(
        'div',
        { id: 'from', className: 'currency-block' },
        _react2.default.createElement(
            'button',
            { className: 'btn', onClick: getPreviousBase },
            '\u25C0'
        ),
        baseCurrency + ' ',
        _react2.default.createElement('input', {
            ...
            onChange: function onChange(evt) {
                return updateBaseValue(+evt.target.value);
            }
        }),
        _react2.default.createElement(
            'button',
            { className: 'btn', onClick: getNextBase },
            '\u25B6'
        )
    );
};
...
BaseBlock.propTypes = {
    baseCurrency: _propTypes2.default.string.isRequired,
    baseValue: _propTypes2.default.number.isRequired,
    getPreviousBase: _propTypes2.default.func.isRequired,
    getNextBase: _propTypes2.default.func.isRequired,
    updateBaseValue: _propTypes2.default.func.isRequired
};
...
var TargetBlock = function TargetBlock(_ref) {
    var targetCurrency = _ref.targetCurrency,
        baseValue = _ref.baseValue,
        rate = _ref.rate,
        getPreviousTarget = _ref.getPreviousTarget,
        getNextTarget = _ref.getNextTarget;
    return _react2.default.createElement(
        'div',
        { id: 'to', className: 'currency-block' },
        _react2.default.createElement(
            'button',
            { className: 'btn', onClick: getPreviousTarget },
            '\u25C0'
        ),
        targetCurrency + ' ' + (rate * baseValue).toFixed(2),
        _react2.default.createElement(
            'button',
            { className: 'btn', onClick: getNextTarget },
            '\u25B6'
        )
    );
};
...
TargetBlock.propTypes = {
    ...
    targetCurrency: _propTypes2.default.string.isRequired,
    rate: _propTypes2.default.number.isRequired,
    getPreviousTarget: _propTypes2.default.func.isRequired,
    getNextTarget: _propTypes2.default.func.isRequired
};
...
// module
exports.push([module.i, ".currency-block {\n  width: 300px;\n  height: 50px;\n  border: 1px solid black;\n  display: flex;\n  justify-content: space-around;\n  align-items: center; }\n\n.btn {\n  cursor: pointer; }\n", ""]);
