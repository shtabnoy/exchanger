...
exports.getExchangeRates = exports.setTargetCurrency = exports.exchangeError = exports.exchangeSuccess = exports.exchangeIsLoading = exports.SET_TARGET_CURRENCY = exports.EXCHANGE_ERROR = exports.EXCHANGE_SUCCESS = exports.EXCHANGE_LOADING = undefined;
...
var App = function (_Component) {
    ...
    function App() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = App.__proto__ || Object.getPrototypeOf(App)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
            ...
            _this.startPoll(currencies[(nextCurrencyIndex % len + len) % len]);
        }, _this.getPreviousBase = function () {
            var currencies = _this.props.currencies;

            var len = currencies.length;
            var previousCurrencyIndex = currencies.indexOf(_this.getBaseCurrency()) - 1;
            _this.startPoll(currencies[(previousCurrencyIndex % len + len) % len]);
        ...
        }, _this.startPoll = function (baseCurrency) {
            _this.props.getExchangeRates(baseCurrency);
            clearTimeout(_this.timeout);
            _this.timeout = setTimeout(function () {
                return _this.startPoll(baseCurrency);
            }, 10000);
